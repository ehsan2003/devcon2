    ...
    protected middleware: PostsLikeRequestHandler[]
        ...
        async (req, res) => {
            ...
            if (result.nMatched === 0)
                throw new NotFoundError(ErrorCodes.ERROR_POSTS_LIKE_$_NOT_FOUND, 'post not found');
            if (result.nModified === 0)
                throw new ConflictError(ErrorCodes.ERROR_POSTS_LIKE_$_ALREADY_LIKED, 'already liked');
