...
export enum Codes {
    ...
    USER_VERIFICATION_INVALID_TOKEN,
    USER_VERIFICATION_DUPLICATE_VERIFICATION_DATA,
    USER_RESET_PASSWORD_USER_NOT_FOUND,
    USER_RESET_PASSWORD_INVALID_TOKEN,
    USER_CHANGE_PASSWORD_INVALID,
    USER_CHANGE_ROLE_FORBIDDEN,
    USER_CHANGE_ROLE_USER_NOT_FOUND,
    TAGS_INSERT_DUPLICATE_SLUG,
    TAGS_DELETE_NOT_FOUND,
    TAGS_SEARCH_TAG_NOT_FOUND,
    CATEGORIES_INSERT_DUPLICATE_SLUG,
    CATEGORIES_UPDATE_CATEGORY_NOT_FOUND,
    CATEGORIES_DELETE_CATEGORY_NOT_FOUND,
    CATEGORIES_DELETE_DEPENDENCY_ERROR,
    CATEGORIES_SEARCH_NOT_FOUND,
    COMMENTS_INSERT_AUTHORIZED,
    COMMENTS_INSERT_RELATION_ERROR,
    COMMENTS_INSERT_UNAUTHORIZED_RELATION_ERROR,
    COMMENTS_INSERT_UNAUTHORIZED_RESPONSE_TO_NOT_FOUND,
    COMMENTS_GET_POST_COMMENTS_NOT_FOUND,
    COMMENTS_GET_RESPONSES_NOT_FOUND,
    POST_INSERT_DUPLICATE_SLUG,
    POST_UPDATE_POST_NOT_FOUND,
    POST_UPDATE_ACCESS_FORBIDDEN,
    POSTS_UPDATE_DUPLICATE_SLUG,
    POSTS_DELETE_NOT_FOUND,
    POSTS_DELETE_ACCESS_FORBIDDEN,
    POSTS_VISIBLE_ACCESS_FORBIDDEN,
    POSTS_VISIBLE_POST_NOT_FOUND,
    POSTS_GET_NOT_FOUND,
    POST_LIKE_ALREADY_LIKED,
    POST_LIKE_NOT_FOUND,
    POST_DISLIKE_ALREADY_LIKED,
    POST_DISLIKE_NOT_FOUND,
    POSTS_SEARCH_CATEGORY_NOT_FOUND,
    PROFILE_CREATE_ALREADY_EXISTS,
    PROFILE_CREATE_DUPLICATE_SLUG,
    PROFILES_GET_SLUG_NOT_FOUND,
    PROFILE_GET_ID_NOT_FOUND,
    PROFILE_UPDATE_NOT_FOUND,
    IMAGES_CHANGE_SLUG_NOT_FOUND,
    IMAGES_CHANGE_ACCESS_NOT_FOUND,
    IMAGES_DATA_NOT_FOUND,
    IMAGES_REMOVE_NOT_FOUND,
    CHANGE_INFO_NOT_FOUND,
    UPLOAD_IMAGE_POST_NOT_FOUND,
    UPLOAD_IMAGE_PROFILE_NOT_FOUND,
    UPLOAD_IMAGE_AVATAR_NO_FILE,
    UPLOAD_IMAGE_POST_UPDATE_NOT_FOUND,
    UPLOAD_IMAGE_POST_UPDATE_NO_FILE,
    FILE_PROTECTION_FILE_INACCESSIBLE,
    AUTHORIZATION_USER_NOT_FOUND,
}
